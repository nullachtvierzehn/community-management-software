...
CREATE POLICY manage_as_moderator ON app_public.room_subscriptions USING ((id IN ( SELECT app_public.my_subscribed_room_ids(minimum_role => 'moderator'::app_public.room_role) AS my_subscribed_room_ids)));
