...
--
-- Name: latest_active_submission(app_public.space_items); Type: FUNCTION; Schema: app_public; Owner: -
--

CREATE FUNCTION app_public.latest_active_submission(i app_public.space_items) RETURNS app_public.space_submissions
...
--
-- Name: FUNCTION latest_active_submission(i app_public.space_items); Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON FUNCTION app_public.latest_active_submission(i app_public.space_items) IS '@behavior +filterBy +orderBy +typeField';
...
--
-- Name: space_submissions_on_editor_id; Type: INDEX; Schema: app_public; Owner: -
--
...
--
-- Name: space_submissions_on_space_item_id; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX space_submissions_on_space_item_id ON app_public.space_submissions USING btree (space_item_id);
...
--
-- Name: space_submissions space_item; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.space_submissions
    ADD CONSTRAINT space_item FOREIGN KEY (space_item_id) REFERENCES app_public.space_items(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE POLICY select_as_reviewer ON app_public.space_submissions FOR SELECT TO null814_cms_app_users USING ((id IN ( SELECT space_item_submissions_and_reviews.submission_id
   FROM app_hidden.space_item_submissions_and_reviews
  WHERE ((space_item_submissions_and_reviews.space_id IN ( SELECT app_public.my_space_ids(with_any_abilities => '{accept,manage}'::app_public.ability[]) AS my_space_ids)) OR (space_item_submissions_and_reviews.organization_id IN ( SELECT app_public.my_organization_ids(with_any_abilities => '{accept,manage}'::app_public.ability[]) AS my_organization_ids))))));
...
--
-- Name: FUNCTION latest_active_submission(i app_public.space_items); Type: ACL; Schema: app_public; Owner: -
--

REVOKE ALL ON FUNCTION app_public.latest_active_submission(i app_public.space_items) FROM PUBLIC;
GRANT ALL ON FUNCTION app_public.latest_active_submission(i app_public.space_items) TO null814_cms_app_users;
